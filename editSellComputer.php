...
<div class="form-group col-md-12">
    ...
    <input type="text" name="pcname" style="width:98%;" value="name">
  </div>
  <div class="form-row">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" name="pcgpu" class="form-control" value="graphics card">
    </div>
    <div class="form-group col-md-6">
      <label>CPU</label>
      <input type="text" name="pccpu" class="form-control" value="intel">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label>RAM in GB</label>
      <input type="number" name="pcram" class="form-control" style="width:95.4%" value="16">
    </div>
    <div class="form-group col-md-6">
      <label>Storage in GB</label>
      <input type="number" name="pcstorage" class="form-control" style="width:95.4%" value="1000">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label>Computer OS</label>
      <input list="pcos" name="pcos" class="form-control" style="width:95.4%" value="OS">
        <datalist id="pcos">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name="pccolor" class="form-control" value="black">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-12">
      <label>Description</label>
      <textarea class="form-control" name="description" rows="4" style="width:98%">Text description</textarea>
    </div>
  </div>
  <div class="form-group" style="padding-left:10px;">
      <label>Price In Whole Number:</label><br>
      <label>$</label><input type="number" name="price" min="1" value="1000"/>
  </div>
